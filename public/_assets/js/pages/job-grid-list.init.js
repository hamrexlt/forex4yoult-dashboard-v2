		...
		1 == currentPage
			? ((itemsPerPage = 7),
				document
					...
					.insertAdjacentHTML(
						"afterbegin",
						'<div class="col-lg-3 col-md-6" id="job-widget">        <div class="card card-height-100 bg-info bg-job">            <div class="card-body p-5">                <h2 class="lh-base text-white">Velzon invites young professionals for an intership!</h2>                <p class="text-white-75 mb-0 fs-14">Don\'t miss your opportunity to improve your skills!</p>                <div class="mt-5 pt-2">                    <button type="button" class="btn btn-light w-100">View More <i class="ri-arrow-right-line align-bottom"></i></button>                </div>            </div>        </div>    </div>',
					))
			: (itemsPerPage = 8);
	for (
			...
			e = allJobList.filter(function (t) {
				...
				return (
					...
					(n =
						...
						new Date(t.postDate) <= new Date(d)),
					(a && i && n) ||
