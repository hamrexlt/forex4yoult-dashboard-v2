document.querySelectorAll(".checkout-tab") &&
	Array.from(document.querySelectorAll(".checkout-tab")).forEach(function (t) {
		t.querySelectorAll(".nexttab") &&
			...
			t.querySelectorAll(".previestab") &&
				Array.from(t.querySelectorAll(".previestab")).forEach(function (r) {
					r.addEventListener("click", function () {
						for (
							...
							r.closest("form").querySelectorAll(".custom-nav .done")[t] &&
								r
									.closest("form")
				...
				e.setAttribute("data-position", o),
					e.addEventListener("click", function () {
						0 < t.querySelectorAll(".custom-nav .done").length &&
							Array.from(t.querySelectorAll(".custom-nav .done")).forEach(
								function (e) {
